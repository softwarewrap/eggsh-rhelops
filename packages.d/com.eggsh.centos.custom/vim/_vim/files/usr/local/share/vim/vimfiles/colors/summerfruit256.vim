...
"   exec "hi CursorLine gui=underline cterm=underline ctermfg=NONE guifg=NONE"
    exec "hi CursorLine cterm=bold ctermbg=255 guifg=NONE"
...
"   call <SID>X("MatchParen", "000000", "d7ffaf", "")
    ...
    call <SID>X("Comment", "008700", "", "bold")
    exec "hi Comment cterm=bold"
